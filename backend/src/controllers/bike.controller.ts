...
export const createBike: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(201)
      .json(new ApiResponse(201, "Bike created successfully", result));
  } catch (error) {
    next(error);
  }
};
...
export const updateBike: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, "Bike updated successfully", result));
  } catch (error) {
    next(error);
  }
};
...
export const deleteBike: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, "Bike deleted successfully", result));
  } catch (error) {
    next(error);
  }
};
...
export const compareBikes: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, "Bikes compared successfully", result));
  } catch (error) {
    next(error);
  }
};
