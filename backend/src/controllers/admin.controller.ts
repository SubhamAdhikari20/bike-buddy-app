...
export const dashboard: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(
        new ApiResponse(200, "Dashboard summary fetched successfully", result),
      );
  } catch (error) {
    next(error);
  }
...
export const listBikes: RequestHandler = async (req, res, next) => {
  try {
    const result = await adminService.listBikes(
      req.query as Record<string, unknown>,
    );
    res
      .status(200)
...
export const hideReview: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, "Review hidden successfully", result));
  } catch (error) {
    next(error);
  }
};
...
export const updateBikeStatus: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, "Bike status updated successfully", result));
  } catch (error) {
    next(error);
  }
};
...
export const updateBookingStatus: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(
        new ApiResponse(200, "Booking status updated successfully", result),
      );
  } catch (error) {
    next(error);
  }
